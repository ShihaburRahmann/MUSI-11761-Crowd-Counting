...
def calculate_metrics(centroids,annotations):
    ...
    for i, c in enumerate(centroids):
        ...
        if min <=0.45 and not match_annotations[closest_annotation]:
            tp +=1
    ...
    return precision, recall,f1_score,mse     
...
def main():
    # Example usage
    background_path = "MUSI-11761-Crowd-Counting/aina/raw_images/1660366800.jpg"
    image_path = "MUSI-11761-Crowd-Counting/aina/raw_images/1660402800.jpg"
    # image_path = "raw_images/1660388400.jpg"
    # image_path = "raw_images/1660392000.jpg"

    csv_path = "MUSI-11761-Crowd-Counting/aina/labels.csv"
